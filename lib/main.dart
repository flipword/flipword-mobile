...
Future<dynamic> main() async {
  ...
  runApp(TranslationProvider(
    child: DevicePreview(
      ...
      enabled: Constanants.isDebuggable!,
    ),
  ));
}
                    ...
                    ? snapshot.hasError
                        ? Scaffold(
                            ...
                            child: Column(children: [
                              ...
                              Text(
                                  'Error at application startup: ${snapshot.error} | StackTrace: ${snapshot.stackTrace.toString()}')
                            ]),
                          ))
                        : Observer(builder: (context) {
                            if (_profilStore.currentProfile.status ==
                                FutureStatus.pending) {
                              return const SizedBox();
                            } else {
                              if (_profilStore
                                  .currentProfile.value!.hasDidMainOnBoarding) {
